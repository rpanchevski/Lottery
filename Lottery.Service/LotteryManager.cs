...
namespace Lottery.Service
{
    public class LotteryManager : ILotteryManager
    {
        ...
        public LotteryManager(IRepository<Code> codeRepository, IRepository<UserCode> userCodeRepository,
            IRepository<Award> awardRepository, IRepository<UserCodeAward> userCodeAwardRepository, DbContext dbContext)
        {
        ...
        public List<UserCodeAwardModel> GetWinnerList()
        {
        ...
        private Award GetRandomAward(RuffledType type)
        {
            ...
            var awardedAwards = _userCodeAwardRepository.GetAll().Where(x => x.Award.RuffledType == (byte) type)
                .Select(x => x.Award)
                .GroupBy(x => x.Id)
                .ToList();
            ...
            foreach (var award in awards)
            {
                ...
                var awardsLeft = award.NumberOfAwards - numberOfAwardedAwards;
